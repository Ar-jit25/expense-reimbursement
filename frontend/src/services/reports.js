...
export const reportsService = {
  ...
  async updateReport(id, data) { return apiClient(`/reports/${id}`, { method: 'PUT', body: JSON.stringify(data) }); },
  async updateExpenseLine(reportId, lineId, data) { return apiClient(`/reports/${reportId}/lines/${lineId}`, { method: 'PUT', body: JSON.stringify(data) }); },
  async archiveReport(id) { return apiClient(`/reports/${id}/archive`, { method: 'PUT' }); },
  async restoreReport(id) { return apiClient(`/reports/${id}/restore`, { method: 'PUT' }); },
  async payReport(id) { return apiClient(`/reports/${id}/pay`, { method: 'POST' }); },
  async resetToDraft(id) { return apiClient(`/reports/${id}/reset`, { method: 'POST' }); },
